...
public final class QueryUtils {
    ...
    //USGS Url from which JSON is recieved
    ...
    /**
     * Create a URL for the HTTP request to use
     *
     * @param urlString the address that needs to be reached useing an http request
     * @return url
     */
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Problem retrieving Json earthquake results");
        } finally {
